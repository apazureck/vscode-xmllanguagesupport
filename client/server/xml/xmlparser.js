...
class XmlMissingClosingTagError extends XmlParserError {
    constructor(startingTag, foundClosingTag) {
        super(foundClosingTag.start, "Missing closing tag");
        this.startingTag = startingTag;
        this.foundClosingTag = foundClosingTag;
    }
}
exports.XmlMissingClosingTagError = XmlMissingClosingTagError;
